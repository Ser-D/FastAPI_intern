...
class QuizResultRepository:
    ...
    async def create_quiz_result(self, db: AsyncSession, user_id: int, company_id: int, quiz_id: int,
                                 correct_answers: int, total_questions: int, score: float) -> QuizResult:
